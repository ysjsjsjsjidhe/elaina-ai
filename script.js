...
async function sendMessage() {
    ...
    appendMsg("Elaina sedang mengetik...", 'elaina-msg', false, typingId);
    ...
    try {
        ...
        appendMsg(aiResp, 'elaina-msg'); // <--- Ini harusnya respon dari AI Gemini

    } catch (error) {
        // Jika error, baru dia menjalankan engine lokal sebagai cadangan
        document.getElementById(typingId).innerText = elainaNarrativeEngine(msg.toLowerCase());
    }
    updateUI();
}
